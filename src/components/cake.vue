                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 5px;">
                                                        <button type="submit" @click="updated(iid)" class="btn btn-warning" style="margin-top: 20px;box-shadow: 5px 5px 5px 5px rgba(20,20,20,.1);"> ซื้อสินค้า </button>
                                                    </td>
                                                </tr>
                                        </table>
...
export default {
    ...
    async created(){
        ...
        let apIURL = `http://cafecake.app.ruk-com.cloud/api/edit-Users/${this.$route.params.id}`;
        await axios.get(apIURL).then((res) => {
            this.user = res.data
        })
    },
